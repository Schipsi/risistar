...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a63424ceead87_64459619',
...
function content_5a63424ceead87_64459619 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
...
<div id="content">
    ...
    <table style="width:569px;margin-top:30px;">
		...
		<tr>
            <td>
				<div><label style="display:inline-block;width:100px;">Username:</label><input type="text" readonly value="<?php echo $_smarty_tpl->tpl_vars['username']->value;?>
"></div>
				<div><label style="display:inline-block;width:100px;">Password:</label><input type="password" name="admin_pw"></div>
