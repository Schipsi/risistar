...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a634294de9e29_85567994',
...
function content_5a634294de9e29_85567994 (Smarty_Internal_Template $_smarty_tpl) {
...
">Shortcuts (<a href="#" onclick="EditShortcuts();return false" class="shortcut-link-edit shortcut-link">Edit Shortcut</a><a href="#" onclick="SaveShortcuts();return false" class="shortcut-edit">Save Shortcut</a>)</th>
		</tr>
		<?php
...
if ($_smarty_tpl->tpl_vars['shortcutRow']->value['type'] == 1) {
echo $_smarty_tpl->tpl_vars['LNG']->value['fl_planet_shortcut'];
} elseif ($_smarty_tpl->tpl_vars['shortcutRow']->value['type'] == 2) {
echo $_smarty_tpl->tpl_vars['LNG']->value['fl_debris_shortcut'];
} elseif ($_smarty_tpl->tpl_vars['shortcutRow']->value['type'] == 3) {
echo $_smarty_tpl->tpl_vars['LNG']->value['fl_moon_shortcut'];
}?> [<?php echo $_smarty_tpl->tpl_vars['shortcutRow']->value['galaxy'];?>
:<?php echo $_smarty_tpl->tpl_vars['shortcutRow']->value['system'];?>
:<?php echo $_smarty_tpl->tpl_vars['shortcutRow']->value['planet'];?>
]</a>
				</div>
...
" size="3" maxlength="2">
			...
			<?php $_smarty_tpl->_assignInScope('to', $_smarty_tpl->tpl_vars['themeSettings']->value['SHORTCUT_ROWS_ON_FLEET1']-($_smarty_tpl->tpl_vars['shortcutRow']->iteration%$_smarty_tpl->tpl_vars['themeSettings']->value['SHORTCUT_ROWS_ON_FLEET1']) ,true);
?>
			<?php
...
?>
		...
		<tr style="height:20px;" class="shortcut-edit shortcut-new">
			<td>
				...
				<div class="shortcut-edit">
					<input type="text" class="shortcut-input" name="shortcut[][name]" placeholder="Name">
					<div class="shortcut-delete" title="Delete"></div>
				</div>
				<div class="shortcut-edit">
		...
		<tr style="height:20px;" class="shortcut-edit">
			<td colspan="<?php echo $_smarty_tpl->tpl_vars['themeSettings']->value['SHORTCUT_ROWS_ON_FLEET1'];?>
">
				<a href="#" onclick="AddShortcuts();return false">Add</a>
			</td>
		</tr>		
	</table>
		<table class="table519" style="table-layout: fixed;">
...
if ($_smarty_tpl->tpl_vars['ColonyRow']->value['type'] == 3) {
echo $_smarty_tpl->tpl_vars['LNG']->value['fl_moon_shortcut'];
}?> [<?php echo $_smarty_tpl->tpl_vars['ColonyRow']->value['galaxy'];?>
:<?php echo $_smarty_tpl->tpl_vars['ColonyRow']->value['system'];?>
:<?php echo $_smarty_tpl->tpl_vars['ColonyRow']->value['planet'];?>
]</a>
		</td>
		...
		<?php $_smarty_tpl->_assignInScope('to', $_smarty_tpl->tpl_vars['themeSettings']->value['COLONY_ROWS_ON_FLEET1']-($_smarty_tpl->tpl_vars['ColonyRow']->iteration%$_smarty_tpl->tpl_vars['themeSettings']->value['COLONY_ROWS_ON_FLEET1']) ,true);
?>
		<?php
$_smarty_tpl->tpl_vars['foo'] = new Smarty_Variable(null, $_smarty_tpl->isRenderingCache);$_smarty_tpl->tpl_vars['foo']->step = 1;$_smarty_tpl->tpl_vars['foo']->total = (int) ceil(($_smarty_tpl->tpl_vars['foo']->step > 0 ? $_smarty_tpl->tpl_vars['to']->value+1 - (1) : 1-($_smarty_tpl->tpl_vars['to']->value)+1)/abs($_smarty_tpl->tpl_vars['foo']->step));
if ($_smarty_tpl->tpl_vars['foo']->total > 0) {
...
:<?php echo $_smarty_tpl->tpl_vars['ACSRow']->value['planet'];?>
		...
		<?php $_smarty_tpl->_assignInScope('to', $_smarty_tpl->tpl_vars['themeSettings']->value['ACS_ROWS_ON_FLEET1']-($_smarty_tpl->tpl_vars['ACSRow']->iteration%$_smarty_tpl->tpl_vars['themeSettings']->value['ACS_ROWS_ON_FLEET1']) ,true);
?>
		<?php
$_smarty_tpl->tpl_vars['foo'] = new Smarty_Variable(null, $_smarty_tpl->isRenderingCache);$_smarty_tpl->tpl_vars['foo']->step = 1;$_smarty_tpl->tpl_vars['foo']->total = (int) ceil(($_smarty_tpl->tpl_vars['foo']->step > 0 ? $_smarty_tpl->tpl_vars['to']->value+1 - (1) : 1-($_smarty_tpl->tpl_vars['to']->value)+1)/abs($_smarty_tpl->tpl_vars['foo']->step));
if ($_smarty_tpl->tpl_vars['foo']->total > 0) {
