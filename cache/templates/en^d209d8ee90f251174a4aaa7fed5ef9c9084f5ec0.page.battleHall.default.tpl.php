...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a6348785b59d5_85833777',
...
function content_5a6348785b59d5_85833777 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="no-js"> <!--<![endif]-->
<head>
	<title>Hall of Fame - <?php echo $_smarty_tpl->tpl_vars['uni_name']->value;?>
...
<tr>
    <td colspan="4">The whole team congratulates the top 100 </td>
</tr>
<tr>
    <td>Place</td>
	<td>Users involved</td>
    <td><a href="game.php?page=battleHall&order=date&sort=<?php if ($_smarty_tpl->tpl_vars['sort']->value == "ASC") {?>DESC<?php } else { ?>ASC<?php }?>"<?php if ($_smarty_tpl->tpl_vars['order']->value == "date") {?> style="font-weight:bold;"<?php }?>>Date</a></td>
	<td><a href="game.php?page=battleHall&order=units&sort=<?php if ($_smarty_tpl->tpl_vars['sort']->value == "ASC") {?>DESC<?php } else { ?>ASC<?php }?>"<?php if ($_smarty_tpl->tpl_vars['order']->value == "units") {?> style="font-weight:bold;"<?php }?>>Units</a></td>
</tr>
<?php
...
?>
    <tr class="day<?php echo floor($_smarty_tpl->tpl_vars['row']->value['date']/86400);?>
 week<?php echo floor($_smarty_tpl->tpl_vars['row']->value['date']/604800);?>
">
        <td><?php echo $_smarty_tpl->tpl_vars['row']->iteration;?>
</td>
        <td><a href="game.php?page=raport&amp;mode=battlehall&amp;raport=<?php echo $_smarty_tpl->tpl_vars['row']->value['rid'];?>
" target="_blank">
        <?php if ($_smarty_tpl->tpl_vars['row']->value['result'] == "a") {?>
        <span style="color:#00FF00"><?php echo $_smarty_tpl->tpl_vars['row']->value['attacker'];?>
</span> VS <span style="color:#FF0000"><?php echo $_smarty_tpl->tpl_vars['row']->value['defender'];?>
</span>
        <?php } elseif ($_smarty_tpl->tpl_vars['row']->value['result'] == "r") {?>
        <span style="color:#FF0000"><?php echo $_smarty_tpl->tpl_vars['row']->value['attacker'];?>
</span> VS <span style="color:#00FF00"><?php echo $_smarty_tpl->tpl_vars['row']->value['defender'];?>
</span>
        <?php } else { ?>
        <?php echo $_smarty_tpl->tpl_vars['row']->value['attacker'];?>
 VS <?php echo $_smarty_tpl->tpl_vars['row']->value['defender'];?>

        <?php }?>
        </a></td>
        <td><?php echo $_smarty_tpl->tpl_vars['row']->value['date'];?>
</td>
        <td><?php echo pretty_number($_smarty_tpl->tpl_vars['row']->value['units']);?>
</td>
    </tr>
<?php
...
<tr>
<td colspan="4"><b>Legend: </b><span style="color:#00FF00"><b>-Winner-</b></span><span style="color:#FF0000"><b>-Loser-</b></span></td></tr>
</tbody>
</table>
</div>
<?php
