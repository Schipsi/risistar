...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a63487c744a76_60515413',
...
function content_5a63487c744a76_60515413 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
...
<table style="width:100%">
	<tr>
		<td class="transparent" style="width:40%;font-size:22px;font-weight:bold;padding:10px 0 30px;color:<?php if ($_smarty_tpl->tpl_vars['Raport']->value['result'] == "a") {?>lime<?php } elseif ($_smarty_tpl->tpl_vars['Raport']->value['result'] == "r") {?>red<?php } else { ?>white<?php }?>"><?php echo $_smarty_tpl->tpl_vars['Info']->value[0];?>
</td>
		<td class="transparent" style="font-size:22px;font-weight:bold;padding:10px 0 30px;">VS</td>
		<td class="transparent" style="width:40%;font-size:22px;font-weight:bold;padding:10px 0 30px;color:<?php if ($_smarty_tpl->tpl_vars['Raport']->value['result'] == "r") {?>lime<?php } elseif ($_smarty_tpl->tpl_vars['Raport']->value['result'] == "a") {?>red<?php } else { ?>white<?php }?>"><?php echo $_smarty_tpl->tpl_vars['Info']->value[1];?>
</td>
	</tr>
</table>
<?php }?>
...
<?php }?>
<br><br>
The attackers losses: <?php echo pretty_number($_smarty_tpl->tpl_vars['Raport']->value['units'][0]);?>
 units<br>
The defenders losses: <?php echo pretty_number($_smarty_tpl->tpl_vars['Raport']->value['units'][1]);?>
 units<br>
At the coordinates are now: <?php
