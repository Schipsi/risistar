...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a63427255e423_56696074',
...
function content_5a63427255e423_56696074 (Smarty_Internal_Template $_smarty_tpl) {
...
">
	...
	<title>Accueil - <?php echo $_smarty_tpl->tpl_vars['gameName']->value;?>
</title>
...
<header>
	<nav>
		<ul id="menu">
			...
			<li><a href="index.php?page=rules">Règles</a></li>
			<li><a href="index.php?page=battleHall">Hall of Fame</a></li>
			<li><a href="index.php?page=banList">Bannis</a></li>
			<li><a href="index.php?page=disclamer">Contacter un administrateur</a></li>
		</ul>
	</nav>
	<nav>
		...
		<div class="button-box-inner">
			<div class="button-important">
				<a href="index.php?page=register">
					...
					<span class="button-center">S'enregistrer maintenant!</span>
		...
		<div class="button-box-inner">
			...
			<?php }?>
				<a href="index.php?page=screens">
					<span class="button-left"></span>
					<span class="button-center">Capture d'écran</span>
					<span class="button-right"></span>
				</a>
			</div>
		</div>
...
<footer>
	<a href="index.php?page=disclamer">Contacter un administrateur</a><br>Powered by <a href="http://2moons.cc" title="2Moons" target="copy">2Moons</a> 2009-2013
</footer>
</div>
